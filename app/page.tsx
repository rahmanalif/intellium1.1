...
import { SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiFramer, SiVite, SiPrisma, SiSupabase } from 'react-icons/si';
...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col bg-black overflow-x-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-purple-900/20 blur-[120px] rounded-full -z-10 pointer-events-none"></div>
      ...
      {/* Reveal Section - Logo Loop */}
      <section 
        id="reveal-section"
        className={`w-full py-24 flex flex-col items-center justify-center transition-all duration-1000 transform ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
        }`}
      >
        <div className="w-full flex flex-col gap-12">
          {/* <div className="text-center">
            <h2 className="text-zinc-500 text-sm font-medium uppercase tracking-[0.2em] mb-4">Our Tech Stack</h2>
          </div> */}
          <div className="w-full py-10 bg-white/5 border-y border-white/5 relative">
            <LogoLoop
              logos={techLogos}
              speed={40}
              direction="left"
